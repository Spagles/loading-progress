...
- The Faster Game Loading progress window could crash the loading screen if Faster Game Loading's internal data couldn't be read (e.g. after a Faster Game Loading update changes its internals). It now falls back to showing 0 mods loaded instead.
